...
- The 2026-09-11 Issue #44 installed-runtime evidence is the current clean
  ...
  are accepted only when their parameter is not rewritten, while literal-array
  `for...of` computed imports in `openclaw.mjs` remain rejected because
