...
- The 2026-09-08 Issue #44 installed-runtime evidence supersedes the pending
  ...
  `a5c4aa441909855d315afd281229eed5b949a849` remains separate fail-closed evidence,
  not runtime-ready candidate proof: it used an isolated non-production
  auto-created run root and loopback port `20189`, did not start the candidate,
