...
and revalidates completed-session proof after normal `release_pending` /
`finalized` progression even if a malicious fixture bypasses runtime triggers.
