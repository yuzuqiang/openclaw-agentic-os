...
- The 2026-09-11 Issue #44 installed-runtime evidence is fail-closed
  ...
  evidence, not current downstream candidate proof: its Agentic OS generator
  head is not an ancestor of the reviewed lineage, it used an isolated
