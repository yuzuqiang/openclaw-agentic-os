...
class PrivacyTests(unittest.TestCase):
    ...
    def test_packaging_and_retrieval_denylist(self) -> None:
        denied = (
            ...
            "state/agentic-os/control.db.tar.gz",
            "state/agentic-os/control.db.tar",
            "state/agentic-os/control.db.old",
            "state/agentic-os/control.db~",
            "export/control.sqlite.copy",
            "export/control.sqlite~",
            "dump.sqlite.tgz",
            "dump.sqlite.zip",
            "dump.sqlite3.tar.zst",
            "dump.sqlite3~",
            "cache.sqlite3.zst",
            "control.db-wal.xz",
            "control.db.backup.zst",
            "exports/control.db.backup/part0",
            ...
            "state/agentic-os/control.dbbackup",
            "state/agentic-os/control.db.bak1",
            "state/agentic-os/control.dbbak",
            "state/agentic-os/control.dbbak.gz",
            "state/agentic-os/control.dbcopy",
            "state/agentic-os/control.dbcopy.gz",
            "cache.sqlite",
            "cache.sqlitebackup",
            "cache.sqlite-backup",
            "cache.sqlite.backup",
