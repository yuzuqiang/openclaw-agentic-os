...
bound literal calls; unsupported transfers, reflection, launch options, mutable
loader environment/process state, URL constructor shadowing and ambiguous
HTML-comment grammar are rejected. Hashbang comments and ordinary
