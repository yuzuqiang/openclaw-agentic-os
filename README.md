...
- Current design artifact SHA-256: `0b6d5bf0da88469563ca73db2011ae04acaa4089b067125df4d504d4240bbb82`
...
tool alias is `session_status` while DB authority requires the future canonical
`sessions_status` alias. The bounded accepted-session probe in
