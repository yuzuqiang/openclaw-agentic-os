CREATE TEMP TABLE db_authority_canary_binding_migration_guard (
  valid INTEGER NOT NULL CHECK (valid=1)
) STRICT;

INSERT INTO db_authority_canary_binding_migration_guard(valid)
...
CREATE TRIGGER runs_preserve_db_authority_canary_projection_binding_delete
